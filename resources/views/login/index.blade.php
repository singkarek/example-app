        ...
        <form class="border-2 p-5 rounded-lg border-red-300" action="/login" method="POST">
          @csrf
            ...
            <div class="mb-6">
              ...
              <input type="email" name="email" id="email" value="{{ old('email') }}" class="bg-red-50 border border-red-300 text-grey-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-red-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 @error('email') is-invalid @enderror" placeholder="joko@gmail.com" required autofocus>
              @error('email')
            ...
            <div class="mb-6">
              ...
              <input type="password" name="password" id="password" class="bg-red-50 border border-red-300 text-grey-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-red-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" required>
            </div>
